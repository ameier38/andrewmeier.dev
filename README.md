...
Built using:
- [F#](https://fsharp.org/), [ASP.NET](https://docs.microsoft.com/en-us/aspnet/core/?view=aspnetcore-5.0): Web server that generates HTML using F#. 
...
- [hyperscript](https://https://hyperscript.org/): Client scripting language which makes it easy to build dynamic user interfaces.
