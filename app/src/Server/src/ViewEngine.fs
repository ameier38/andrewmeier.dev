...
type Html() =
    ...
    static member main (attrs:HtmlAttribute seq) = Element ("main", attrs)
    static member header (attrs:HtmlAttribute seq) = Element ("header", attrs)
    static member footer (attrs:HtmlAttribute seq) = Element ("footer", attrs)
    ...
    static member article (attrs:HtmlAttribute seq) = Element("article", attrs)
    static member time (attrs:HtmlAttribute seq) = Element("time", attrs)
