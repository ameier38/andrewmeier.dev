...
export const kubeconfig = clusterStack.requireOutput('kubeconfig').apply(o => o as string)
...
export const airtableConfig = {
    baseId: rawAirtableConfig.requireSecret('baseId'),
    apiKey: rawAirtableConfig.requireSecret('apiKey')
}
